  ...
  return (
    <div className="landing-page-container">
      <header className="header">
        <h1>JOB-GPT</h1>
        <p>Apply to dozens of jobs, instantly with the click of a button. Just upload your resume and Job-GPT will take care of the rest!</p>
      </header>
      <main className="upload-container">
        ...
        <button onClick={handleUploadClick} className="upload-confirm-button">
          Submit
        </button>
      </main>
    </div>
